...
export function initializeRegisterForm() {
    ...
    showPasswordIcon.addEventListener('click', (e)=> {
        ...
        showPasswordIcon.textContent = showPasswordIcon.textContent === 'visibility' ? 'visibility_off' : 'visibility';
    ...
    repeatPasswordIcon.addEventListener('click', (e)=> {
        ...
        repeatPasswordIcon.textContent = repeatPasswordIcon.textContent === 'visibility' ? 'visibility_off' : 'visibility';

        repeatPasswordInput.type = repeatPasswordInput.type === 'password' ? 'text' : 'password';
    })
    ...
    registerForm.addEventListener('change', (e)=> {
        ...
        const repeatPasswordErrorText = document.querySelector('#repeatPasswordError');
